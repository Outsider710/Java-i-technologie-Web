...
public class AutoKomis {
    ...
    public AutoKomis() {
        samochody[0].setMarka("VW");
        samochody[0].setModel("Passat B5 FL");
        samochody[0].setPojemnosc(1854);
        samochody[0].setTyp(TypAuta.KOMBI);
        samochody[0].setSilnik("Diesel");
        samochody[0].setRokProdukcji(1999);
        samochody[0].setDataPierwszejRejestracji(new Date(1999, 1, 12));
        samochody[0].setCena(4500);
